cmd_Release/obj.target/iconv/deps/libiconv/lib/iconv.o := cc '-D_LARGEFILE_SOURCE' '-D_FILE_OFFSET_BITS=64' '-DICONV_CONST=const' '-DUSE_AIX=1' '-DUSE_DOS=1' '-DUSE_EXTRA=1' '-DUSE_OSF1=1' '-DLIBDIR="."' '-DHAVE_WORKING_O_NOFOLLOW=1' '-DBUILDING_NODE_EXTENSION' -I/root/.node-gyp/0.8.21/src -I/root/.node-gyp/0.8.21/deps/uv/include -I/root/.node-gyp/0.8.21/deps/v8/include -I../deps/libiconv/srclib -I../support  -fPIC -Wall -pthread -m64 -Wno-unused-function -Wno-unused-parameter -Wno-unused-variable -O2 -fno-strict-aliasing -fno-tree-vrp  -MMD -MF ./Release/.deps/Release/obj.target/iconv/deps/libiconv/lib/iconv.o.d.raw  -c -o Release/obj.target/iconv/deps/libiconv/lib/iconv.o ../deps/libiconv/lib/iconv.c

...
function RiakClient(node_list, client_id, pool_name, pool_opts) {
    ...
    pool_opts = pool_opts || {};
    pool_opts.retry_filter = pool_opts.retry_filter || this.retry_filter.bind(this);
    pool_opts.check_interval = pool_opts.check_interval || 10000;
    pool_opts.name = pool_name;
    pool_opts.keepAlive = pool_opts.keepAlive || true;

    this.pool = new LB_Pool(http, node_list, pool_opts);

...
describe('statsd-singly', function () {
  ...
  describe('DNS resolution', function () {
    ...
    it('should only happen once a minute', function (done) {
      ...
      dns.lookup = function lookup() {
        ...
        originalLookup.apply(lookup, arguments);
      };

      var cbWhilstOob;

      var client = new stats.StatsD('localhost', 1024, function (err) {
      ...
      client.init(function () {
        var metric = client.gauge({ 'total': 1000 });

        async.whilst(function () {
          return count++ < 100;
        },
        function (cbWhilst) {
          cbWhilstOob = cbWhilst;

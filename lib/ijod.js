...
exports.getOnePars = function (targetIdr, cat, cbDone) {
  ...
  if (cat) {
    entryInClause = "x'" + friendUtils.parCat(hash, cat) + "'";
  } else {
    entryInClause = Object.keys(friendUtils.parCats()).map(function (cat) {
      return "x'" + friendUtils.parCat(hash, cat) + "'";
    }).join(",");
  }
...
exports.setOneCat = function (id, cat, options, cbDone) {
  ...
  var binds = [
    ...
    friendUtils.parCat(idr.hash(id), cat),
